...
crontab -u albe -l | { cat; echo "8 */2 * * 0-6 bash /ap/script/tools599/movefiles575/rclone-6365-leanailin-vis1-dock.sh 2>&1 | tee -a /ap/log/rclone/leanailin6365-rclon-vis1-dock.log "; } | crontab -u albe -  #add
