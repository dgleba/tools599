...
set batch_title=rclone_move6365vis0-nas2_d
...
c:\prg\rclone\rclone move   --delete-empty-src-dirs  D:\image_data\SGE_Rotor_6365  \\10.4.65.190\Images\mcdata\mc_6365_vision\image_data -v --log-file=%logdir%\rclone_%dhms%.log.txt
