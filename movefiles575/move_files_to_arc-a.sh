...
s=9631 ; read  -rsp $"Wait $s seconds or press Escape-key or Arrow key to continue..." -t $s -d $'\e'; echo;echo;
...
ddc=albe@10.4.168.94:/media/albe/vi641-001/test_mcdata/image_data/t2
mkdir -p ${ddc}
