...
c:\prg\rclone\rclone copy D:\data\vision_6365_1\image_data  leanai2drive:/mc6365/vis1/image_data/ --max-age=2022-10-13 -vu --progress --stats=30s --log-file=%logdir%\rclone_%~n0_%dhms%.log.txt  
