...
robocopy C:\data\script  \\pmda-sgenas01\PMDA-SGE\backup\mc6365_c_data_script  /e  ^
 /xf *._sync* /xd venv001 6830_xml_to_csv_env vision_performance_tracker_report_env    /dst /fft /xo /ndl /np /r:0 /w:0 /tee /eta /log:%logf4%
