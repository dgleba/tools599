...
set batch_title=recent_move6670vis1-2-nas2
...
cd %utemp&
robocopy /s /move /MINAGE:14 /maxage:18 /dst "D:\Archive Record\images " ^
  \\10.4.65.190\Images\mcdata\mc_6670_vision\image_data\vision-1\images ^
    /r:3 /w:1 /tee /log:rb-recent-6670vis1-nas2_%dt%-%ts%_%random%.log.txt
