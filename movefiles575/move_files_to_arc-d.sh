...
cat ${tfc}.a |grep -P "_19\d{4}T\d{6}|_20\d{4}T\d{6}|_21\d{4}T\d{6}|_2201\d{2}T\d{6}|_2202\d{2}T\d{6}|_2203\d{2}T\d{6}|_2204\d{2}T\d{6}|_2205\d{2}T\d{6}|_2206\d{2}T\d{6}|_2021\d{4}T\d{6}|_202202\d{2}T\d{6}"  | sort -n  > ${tfc}
