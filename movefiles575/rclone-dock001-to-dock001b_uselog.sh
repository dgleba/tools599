...
# usage:         nohup bash /crib/tools599/movefiles575/rclone-dock001-to-dock001b_uselog.sh &
...
pwd; ls -la;
rclone copy   /media/albe/vi641-001/mcdata   /media/albe/vi641-001b/mcdata   --log-file=$logf --log-level INFO \
