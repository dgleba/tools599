...
# usage:         nohup bash /crib/tools599/movefiles575/rclone-dock001-to-dock002_uselog.sh &
...
pwd; ls -la;
rclone copy   /media/albe/vi641-001/mcdata   /media/albe/vi641-002/mcdata   --log-file=$logf --log-level INFO \
