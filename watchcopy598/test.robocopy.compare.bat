...
robocopy "c:\result" C:\data\cmm\watchedoutput\general  /L /e   /fft /dst /xo /ndl /r:1 /w:1 /tee /log:"C:\data\logs\watch598cmmresults\rb-compare.calypso-general-%dhms%-%random%"
