...
robocopy %sourcefolder% C:\data\archive\cmm\calypso-c-result-archive\%ts_yr%-%ts_mon%-minus_lag /s /MOVE  /xf merge__*.txt /xf *.TMP /MINAGE:7 /IS /xo /R:3 /W:4  /tee /log:"C:\data\logs\watch598cmmresults\debug\rb-archi-calyp-%ts_dhms%-%random%"
