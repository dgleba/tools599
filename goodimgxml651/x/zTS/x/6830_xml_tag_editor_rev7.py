...
while True:
    ...
    def zip_back_up_of_xml_files():
                ...
                if ext in extentions_for_csv:
                    ...
                    try:
                        if count == 0:
                            ...
                            Datetime_slice = header.append('Datetime Slice')
            ...
            #Need to append filename in first column before variables from xml file are pulled
                ...
                if ext == extensions:# and current_file_path not in kick_out_list:
                    ...
                    for subdirectories in dirs:
                        ...
                        destination_path = os.path.join(destination_folder_name, subdirectory_path)
        ...
        filename_data.close()
        shutil.copy(csv_file_name, destination_path)
