...
main_folder = r'Z:\training_library_SGE-Rotor6365\2020-11\S1 Outer Surface - Nov 2\20201102'
extensions = ('.xml')

#open a file for writing
xml_data = open('test_for_by_folder.csv', 'w', newline='')
...
for subdirs, dirs, files in os.walk(main_folder):
    ...
    # after the header is created, the count = 1, and so 'if count ==0' gets bypassed, and each new row gets appended
            ...
            # Defect type
                ...
                try:
                    if xml_file_name[10] in xml_file_name:
                        del xml_file_name[0:8]
                        # print(xml_file_name)
