...
root_directory = r'Z:\image_data\DV6_Rotor_6830'
...
report_filename = '6365_xml_to_csv_report-dg1' + '--' + yesterdays_datetime_string[0:10] + '.csv'
...
def get_yesterdays_folder_pathways():
    for subdirs, dirs, files in os.walk(root_directory):
        root_dir_sliced = subdirs[61:]
        # print(root_dir_sliced)
        folder_datestamp = []
        ...
        yesterdays_datetime_string = str(yesterdays_datetime)
        slice_yesterdays_datetime_string = yesterdays_datetime_string[0:10]
